  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-[30px]">
        {user?.addresses?.length > 0 ? (
          user.addresses.map((address, index) => (
            <div key={address._id} className="w-full bg-primarygray p-5 border">
              <div className="flex justify-between items-center">
                <p className="title text-[22px] font-semibold">Address #{index + 1}</p>
                ...
                <table>
                  <tbody>
                    <tr className="flex mb-3">
                      <td className="text-base text-qgraytwo w-[90px]">Street:</td>
                      <td className="text-base text-qblack font-medium">{address.street}</td>
                    </tr>
                    <tr className="flex mb-3">
                      <td className="text-base text-qgraytwo w-[90px]">City:</td>
                      <td className="text-base text-qblack font-medium">{address.city}</td>
                    </tr>
                    <tr className="flex mb-3">
                      <td className="text-base text-qgraytwo w-[90px]">State:</td>
                      <td className="text-base text-qblack font-medium">{address.state}</td>
                    </tr>
                    <tr className="flex mb-3">
                      <td className="text-base text-qgraytwo w-[90px]">Postal Code:</td>
                      <td className="text-base text-qblack font-medium">{address.postalCode}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <div className="w-[180px] h-[50px] mt-4">
        <button type="button" onClick={() => setIsModalOpen(true)} className="yellow-btn">
