...
export default function Dashboard() {
  ...
  const formatHealthStatus = (healthStatus) => {
    ...
    return deficiencies.length > 0 ? deficiencies.join(", ") : "No deficiencies reported";
  };
      ...
      <div className="welcome-msg w-full">
        <div>
          <p className="text-qblack text-lg">
            Hello, {user ? `User ${user.firstName || ""} ${user.lastName || ""}` : "Guest"}
          </p>
          ...
          <div className="mt-5">
            <table>
              <tbody>
                ...
                <tr className="mb-5 block">
                  <td className="text-base text-qgraytwo block mb-1">Health Status:</td>
                  <td className="text-base text-qblack font-medium block">
                    {user ? formatHealthStatus(user.healthStatus) : "Loading..."}
                  </td>
                </tr>
              </tbody>
            </table>
