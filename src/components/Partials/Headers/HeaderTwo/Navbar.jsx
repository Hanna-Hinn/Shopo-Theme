...
export default function Navbar({ className}) {
  ...
  const goToCategory = (category) => {
    const query = category
      ? `?pageNumber=1&categoryName=${category}`
      : "?pageNumber=1";
      ...
      <div className="container-x mx-auto h-full">
              ...
              <div className="category w-[270px] h-[53px] bg-white px-5 rounded-t-md mt-[6px] relative">
                ...
                >
                  <ul className="categories-list">
                    ...
                    <li className="category-item">
                      <div
                        onClick={() => goToCategory("Vegetables")}
                        className="flex justify-between items-center px-5 h-10 bg-white hover:bg-qh2-green transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:text-white"
                      >
                        <div className="flex items-center space-x-6">
                          <span>
		...
		c10.858,16.547,16.556,35.641,16.556,55.712c0,53.673-41.707,97.784-94.413,101.636V255.916z"
          ...
          C441.703,235.439,416.257,327.004,353.574,389.686z M440.89,106.496l-17.269-17.269l17.269-17.271l17.269,17.271L440.89,106.496z"
                    ...
                    <li className="category-item">
                      <div
                        onClick={() => goToCategory("Medicines")}
                        className="flex justify-between items-center px-5 h-10 bg-white hover:bg-qh2-green transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:text-white"
                      >
                        <div className="flex items-center space-x-6">
                          <span>
